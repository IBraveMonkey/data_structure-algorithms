...
[
    {
        "question": "Какую главную задачу решает механизм виртуальной памяти?",
        "options": [
            "Увеличивает объем физической RAM",
            "Создает для каждого процесса изолированное адресное пространство и защищает память одних процессов от других",
            "Ускоряет работу жесткого диска",
            "Удаляет неиспользуемые файлы"
        ],
        "correctIndex": 1
    },
    {
        "question": "Какое устройство отвечает за мгновенный перевод виртуальных адресов в физические?",
        "options": [
            "Блок питания",
            "MMU (Memory Management Unit) совместно с кэшем TLB",
            "Сетевая карта",
            "Видеокарта"
        ],
        "correctIndex": 1
    ...
    {
        "question": "Что такое 'Page Fault' (отказ страницы)?",
        "options": [
            "Критическая ошибка, приводящая к падению системы",
            "Ситуация, когда данных нет в RAM, и ОС должна загрузить их (например, из Swap)",
            "Физическая поломка планки памяти",
            "Ошибка синтаксиса в коде программы"
        ],
        "correctIndex": 1
    }
]
