...
Сложность: O(log n), где n — количество элементов в массиве. Это очень быстро, так как с каждым шагом количество рассматриваемых элементов уменьшается вдвое.

Основные шаги:
-Найти середину массива.
-Сравнить искомый элемент с элементом в середине.
-Если элемент найден — завершить поиск.
-Если искомый элемент меньше — продолжить поиск в левой половине.
-Если больше — в правой половине.
-Повторять, пока элемент не будет найден или массив не закончится.
