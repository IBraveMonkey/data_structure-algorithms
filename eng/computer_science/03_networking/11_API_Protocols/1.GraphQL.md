# 🕸️ GraphQL: Next-Generation Query Language
...
[
    {
        "question": "What primary REST problem does GraphQL solve by allowing clients to request only needed fields?",
        "options": ["Underfetching", "Overfetching", "N+1 Problem", "Data typing"],
        "correctIndex": 1
    },
    {
        "question": "What is a DataLoader in the context of GraphQL?",
        "options": ["A tool for loading frontend apps", "A utility for batching and coalescing database requests to solve the N+1 problem", "A specific data type in the GraphQL schema", "A protocol for file transfers"],
        "correctIndex": 1
    },
    {
        "question": "Which operation in GraphQL is specifically used to modify data on the server?",
