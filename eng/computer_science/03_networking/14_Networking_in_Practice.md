...
Modern applications operate in a world of distributed systems. Even a simple query to a database or Redis is, at its core, a network call.
...
[
    {
        "question": "Why is making 100 sequential network requests considered bad practice?",
        "options": ["It overloads the server CPU", "The cumulative latency becomes too high for the end user", "The database will block such requests", "Network cards don't support more than 10 requests"],
        "correctIndex": 1
    },
    {
        "question": "What is the primary purpose of the Circuit Breaker pattern in distributed systems?",
        "options": ["To speed up mathematical calculations", "To prevent cascading failures by temporarily stopping requests to a failing service", "To automatically restart the database", "To encrypt user passwords"],
        "correctIndex": 1
    },
    {
        "question": "What is Exponential Backoff in the context of Retries?",
        "options": ["Instantly retrying a request 10 times", "Gradually increasing the delay between consecutive failed request attempts", "Decreasing the timeout duration for each attempt", "Randomly selecting a different server for the retry"],
        "correctIndex": 1
    }
]
QUIZ_END -->
