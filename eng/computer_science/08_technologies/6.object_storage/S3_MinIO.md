...
[
    {
        "question": "What is a 'Bucket' in the context of Object Storage?",
        "options": [
            "A hierarchical folder structure",
            "A flat storage space where objects reside",
            "A type of physical hard drive",
            "A database table"
        ],
        "correctIndex": 1
    },
    {
        "question": "Which service defined the modern standard for Object Storage API?",
        "options": [
            "Google Drive",
            "AWS S3",
            "Dropbox",
    ...
    {
        "question": "What is the primary advantage of using MinIO?",
        "options": [
            "It is a proprietary cloud service",
            "It allows you to self-host an S3-compatible storage on your own servers",
            "It is only for storing text files",
