...
[
    {
        "question": "How does Kafka differ from traditional message queues (like RabbitMQ)?",
        "options": [
            "Kafka deletes messages after reading",
            "Kafka stores messages as a distributed commit log without deleting them after reading",
            "Kafka only works with JSON",
            "Kafka doesn't support partitioning"
        ],
        "correctIndex": 1
    },
    {
        "question": "Where does Kafka guarantee message ordering?",
        "options": [
    ...
    {
        "question": "What does the acks=all setting mean when publishing messages to Kafka?",
        "options": [
            "Message is sent without confirmation",
            "Wait for confirmation from the partition leader only",
            "Wait for confirmation from the leader and all in-sync replicas (ISR) for maximum durability",
            "Message is sent to all consumers"
        ],
        "correctIndex": 2
    }
]
