...
[
    {
        ...
        "options": [
            "RabbitMQ is faster",
            "RabbitMQ is a 'smart' broker with message routing, while Kafka is a distributed commit log",
            "RabbitMQ doesn't support queues",
            "RabbitMQ only works with AMQP"
        ],
        "correctIndex": 1
    },
    {
        "question": "Which component in RabbitMQ is responsible for routing messages to queues?",
        "options": [
            "Publisher",
            "Consumer",
            "Exchange",
    ...
    {
        "question": "What happens when using Auto-Ack in RabbitMQ if a consumer crashes during message processing?",
        "options": [
            "The message will be reprocessed",
            "The message is permanently lost",
            "The message automatically goes to DLX",
            "The broker will restart"
        ],
        "correctIndex": 1
    }
]
