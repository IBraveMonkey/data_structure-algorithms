...
**Prometheus** is the de-facto standard for monitoring modern, cloud-native systems. 🛠️
...
2. **Gauge**: A metric that can go up or down. Example: CPU usage, current memory consumption, number of active users. 🌡️
...
- **Saturation**: How "full" your service is (CPU, RAM, Disk I/O). 🛡️
...
[
    ...
    {
        "question": "Which data collection model does Prometheus primarily use?",
        "options": [
            "Push Model (App sends data)",
            "Pull Model (Prometheus requests data)",
            "Streaming Model",
            "Batch File Export"
        ],
        "correctIndex": 1
    ...
    {
        "question": "What type of Prometheus metric is best for counting errors that only ever increase?",
        "options": [
            "Gauge",
            "Counter",
            "Histogram",
