...
[
    {
        "question": "How do Authentication and Authorization differ?",
        "options": [
            "They are synonyms",
            "Authentication checks WHO you are; Authorization checks WHAT you are allowed to do",
            "Authorization is for passwords; Authentication is for fingerprints",
            "Authentication is only required for admins"
        ],
        "correctIndex": 1
    },
    {
        ...
        "options": [
            ...
            "An identity layer (ID Token) to tell the client WHO the user is",
            "A database for storing passwords",
            "Encryption for the entire website"
        ],
        "correctIndex": 1
    },
    {
