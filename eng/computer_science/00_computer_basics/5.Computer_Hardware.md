...
[
    {
        "question": "Which memory is the fastest in the hierarchy, located directly inside the processor?",
        "options": ["RAM (Random Access Memory)", "L3 Cache", "Registers", "SSD"],
        "correctIndex": 2
    },
    {
        "question": "What happens to data in RAM when the power is turned off?",
        "options": ["It is saved", "It is completely erased", "It is moved to the disk", "It is compressed"],
        "correctIndex": 1
    },
    {
        "question": "What is the name of the effect where the processor reduces its clock frequency to protect against overheating?",
        "options": ["Overclocking", "Throttling", "Rendering", "Boosting"],
        "correctIndex": 1
    }
]
QUIZ_END -->
