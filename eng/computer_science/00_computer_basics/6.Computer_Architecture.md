...
[
    {
        ...
        "options": ["Separate memory for code and data", "Using only RISC instructions", "Program code and data are stored in the same memory", "Absence of registers in the processor"],
        "correctIndex": 2
    },
    {
        "question": "Which architecture is commonly used in microcontrollers and separates buses for instructions and data?",
        "options": ["Von Neumann", "Harvard", "CISC", "x86 architecture"],
        "correctIndex": 1
    },
    {
        "question": "What is Pipelining in processor microarchitecture?",
        "options": ["Increasing L1 cache size", "A processor cooling method", "Overlapping the execution of multiple instructions", "A branch prediction method"],
        "correctIndex": 2
    }
]
QUIZ_END -->
