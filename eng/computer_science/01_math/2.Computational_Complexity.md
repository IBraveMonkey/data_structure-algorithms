...
### NP (Nondeterministic Polynomial) — "Easily Verifiable" ❓
...
[
    {
        "question": "What condition must be met for a problem to belong to the NP class?",
        "options": ["It must be solvable in O(n)", "Its solution can be verified in polynomial time", "It cannot have a solution", "It must be undecidable"],
        "correctIndex": 1
    },
    {
        "question": "Which problem was the FIRST proven NP-Complete problem?",
        "options": ["Traveling Salesman Problem (TSP)", "Knapsack Problem", "SAT (Boolean Satisfiability)", "Bubble Sort"],
        "correctIndex": 2
    },
    {
        "question": "What would finding a fast (polynomial-time) algorithm for even ONE NP-Complete problem signify?",
        "options": ["Cryptography would become more secure", "It would prove that P = NP", "It would prove that P ≠ NP", "Nothing would change"],
        "correctIndex": 1
    }
]
QUIZ_END -->
