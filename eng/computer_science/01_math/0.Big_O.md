...
| **O(n!)** | Factorial | ☠️ Catastrophe | Permutations, TSP |
...
[
    {
        "question": "How does the execution time of an algorithm change as n increases by 10x, if its complexity is O(log n)?",
        "options": ["Increases by 10x", "Increases by 100x", "Increases slightly (by a constant)", "Does not change"],
        "correctIndex": 2
    },
    {
        "question": "What is the time complexity of the binary search algorithm in a sorted array?",
        "options": ["O(1)", "O(log n)", "O(n)", "O(n log n)"],
        "correctIndex": 1
    },
    {
        "question": "Which rule is used to simplify Big O expressions, such as O(n² + n)?",
        "options": ["Only the term with the slowest growth rate is kept", "All terms are summed", "Lower-order terms are dropped (remains n²)", "Coefficients of n are multiplied"],
        "correctIndex": 2
    }
]
QUIZ_END -->
