...
[
    {
        "question": "Which data structure does the Breadth-First Search (BFS) algorithm use to store vertices?",
        "options": ["Stack", "Queue", "Tree", "Linked List"],
        "correctIndex": 1
    },
    {
        "question": "Which method of representing a graph in code is most memory-efficient for 'sparse' graphs (where there are few edges)?",
        "options": ["Adjacency Matrix", "Adjacency List", "2D Array", "Truth Table"],
        "correctIndex": 1
    },
    {
        "question": "For which of the following tasks is the BFS algorithm best suited?",
        "options": ["Finding cycles in a graph", "Topological sorting", "Finding the shortest path in an unweighted graph", "Depth-first tree traversal"],
        "correctIndex": 2
    }
]
QUIZ_END -->
