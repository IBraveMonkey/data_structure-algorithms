...
[
    {
        "question": "In how many ways can 3 different books be arranged on a shelf (order is important)?",
        "options": ["3", "6", "9", "1"],
        "correctIndex": 1
    },
    {
        "question": "What is the primary difference between a Combination and an Arrangement?",
        "options": ["A combination uses more elements", "In a combination, the order of selection DOES NOT matter", "Combinations are always larger than arrangements", "The formulas are identical"],
        "correctIndex": 1
    },
    {
        "question": "Which combinatorics rule is used to determine the number of possible 4-digit PIN codes (10^4)?",
        "options": ["Sum Rule", "Division Rule", "Product Rule", "Exclusion Rule"],
        "correctIndex": 2
    }
]
QUIZ_END -->
