...
[
    {
        "question": "Which logical operation is true only if both inputs have DIFFERENT values?",
        "options": ["AND (&&)", "OR (||)", "XOR (^)", "NOT (!)"],
        "correctIndex": 2
    },
    {
        "question": "What is the name of the operation on sets whose result is only those elements that are in both A AND B simultaneously?",
        "options": ["Union", "Difference", "Intersection", "Symmetric Difference"],
        "correctIndex": 2
    },
    {
        "question": "According to De Morgan's second law, what is the logical expression !(A || B) equivalent to?",
