...
**Complexity**: $O(n \log \log n)$ — incredibly fast!
...
**Complexity**: $O(\log \min(a, b))$ — near-instantaneous even for large numbers.
...
Modular arithmetic is "clock arithmetic" — working with remainders.
...
> [!TIP]
> Number Theory isn't just theory—it powers the security and efficiency of almost every digital system we use today!

<!-- QUIZ_START 
[
    {
        "question": "Which algorithm is most effective for finding ALL prime numbers up to a given number N?",
        "options": ["Euclidean Algorithm", "Sieve of Eratosthenes", "Linear Search", "Modular Exponentiation"],
        "correctIndex": 1
    },
    {
    ...
    {
        "question": "What is the time complexity of the classic Euclidean algorithm for finding the GCD?",
