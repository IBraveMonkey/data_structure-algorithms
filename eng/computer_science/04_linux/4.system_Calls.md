...
## 4. 🚀 Expert: Optimizations (vDSO & vsyscall)
...
[
    {
        "question": "Which processor privilege level (Protection Ring) corresponds to Kernel Mode?",
        "options": ["Ring 3", "Ring 1", "Ring 0", "Ring 7"],
        "correctIndex": 2
    },
    {
        "question": "What is vDSO in the context of Linux?",
        "options": ["A video card driver", "A kernel memory segment allowing certain syscalls to run in User Space without a context switch", "A virtual hard drive", "A remote access protocol"],
        "correctIndex": 1
    },
    {
        "question": "Which tool is primarily used to trace all system calls made by a running program?",
