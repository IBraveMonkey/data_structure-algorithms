...
## 🏗 How it Works (The Telephone Analogy)
...
[
    {
        "question": "What is the main difference between a Socket Descriptor and a regular File Descriptor for a file on disk?",
        "options": ["You cannot apply `lseek` (rewind) to a socket because it is a stream", "A socket cannot be closed", "A socket does not have an FD number", "A socket can only read text"],
        "correctIndex": 0
    },
    {
        "question": "Which system call in the telephone analogy corresponds to 'picking up the receiver' for an incoming call?",
        "options": ["socket()", "bind()", "listen()", "accept()"],
        "correctIndex": 3
    },
    {
        "question": "Which table in iptables is the primary one for traffic filtering (allowing or dropping packets)?",
