...
### 1️⃣ Process Descriptor Table (FD Table)
...
### 2️⃣ System-wide Open File Table (Open File Description)
...
[
    {
        ...
        "options": ["The name of a file within a directory", "An object storing file metadata (permissions, owner, blocks) but not its name", "A type of random access memory", "A command for creating directories"],
        "correctIndex": 1
    },
    {
        "question": "Which system call allows duplicating a file descriptor to point to the same entry in the Global File Table?",
        "options": ["fork", "exec", "dup2", "lseek"],
        "correctIndex": 2
    },
    {
        "question": "What happens to the file offset after a `fork()` call?",
        "options": ["It is reset to zero for the child", "It becomes randomized", "It is shared between the parent and the child", "The child loses access to the file"],
        "correctIndex": 2
    }
]
QUIZ_END -->
