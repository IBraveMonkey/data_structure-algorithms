...
*   `HSET user:100 name "Boris" age 25`.
...
[
    {
        "question": "Which Redis data type is ideal for implementing leaderboards?",
        "options": ["String", "List", "Sorted Set (ZSet)", "Hash"],
        "correctIndex": 2
    },
    {
        "question": "What is a unique characteristic of the execution model in classic Redis?",
        "options": ["Multithreading", "Single-threading", "GPU-only execution", "Lack of memory support"],
        "correctIndex": 1
    },
    {
        "question": "Which Redis persistence mechanism writes every command to a log file?",
