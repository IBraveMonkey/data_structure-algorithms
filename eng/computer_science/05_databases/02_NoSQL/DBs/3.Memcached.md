...
[
    {
        "question": "What is the key architectural difference between Memcached and Redis?",
        "options": ["Support for complex data structures", "Persistence to disk", "Multithreading", "Built-in Lua support"],
        "correctIndex": 2
    },
    {
        "question": "Why is the LRU algorithm used in Memcached?",
        "options": ["To encrypt data", "To remove old data when memory is full", "To communicate with the database", "To sort keys"],
        "correctIndex": 1
    }
]
QUIZ_END -->