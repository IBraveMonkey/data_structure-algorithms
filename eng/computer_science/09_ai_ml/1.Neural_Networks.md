...
## 🔄 Training: Backpropagation and Optimizers
...
## 🏗️ Normalization and Initialization
...
> [!IMPORTANT]
> **Vanishing Gradient**: In very deep networks using Sigmoid, the gradient becomes smaller and smaller through multiplication (Chain Rule) until it turns into 0. As a result, the early layers don't learn at all. Solution — **ReLU** and **Batch Norm**.

---

---

> 3. Try a simpler or more complex architecture depending on your data size. 🛠️

<!-- QUIZ_START 

[
    {
        "question": "Which activation function is the current standard for hidden layers and computed as max(0, x)?",
        "options": [
            "Sigmoid",
            "Softmax",
            "ReLU",
    ...
    {
        "question": "Which loss function should you choose for a multi-class classification problem?",
        "options": [
            "MSE",
    ...
    {
        "question": "The Backpropagation algorithm is fundamentally based on which calculus rule?",
        "options": [
            "Power Rule",
            "Chain Rule",
            "Product Rule",
