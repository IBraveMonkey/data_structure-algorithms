...
[
    {
        "question": "What are 'Features' (X) in machine learning context?",
        "options": [
            "The final prediction",
            "Input parameters (e.g., house area)",
            "The training process",
            "Model settings like learning rate"
        ],
        "correctIndex": 1
    },
    {
        "question": "Which type of learning describes mapping inputs to known correct answers?",
        "options": [
    ...
    {
        "question": "What is the purpose of MinMaxScaler in preprocessing?",
        "options": [
            "To fill missing values",
            "To convert text to numbers",
            "To squeeze values into the [0, 1] range",
