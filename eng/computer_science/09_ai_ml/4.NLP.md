...
[
    {
        "question": "Which process breaks text into smaller units (tokens) for processing by a model?",
        "options": [
            "Vectorization",
            "Tokenization",
            "Encoding",
    ...
    {
        "question": "What is the key advantage of BERT over standard Word2Vec?",
        "options": [
            "It is faster to train",
            "It supports more languages",
            "It provides contextual embeddings (meaning changes based on surrounding words)",
            "It uses less memory"
        ],
        "correctIndex": 2
    },
    {
        "question": "Which technology allows an LLM to 'refer' to a private knowledge base (PDF/DB) to answer questions?",
        "options": [
            "Zero-shot Learning",
            "RAG (Retrieval-Augmented Generation)",
            "Batch Normalization",
