...
[
    {
        "question": "Which architecture is specifically designed for processing data with a grid-like structure, such as images?",
        "options": [
            "RNN",
            "Transformer",
            "Linear Regression",
    ...
    {
        "question": "In a CNN, what is used to 'slide' over the image to extract features?",
        "options": [
            "Decision Trees",
            "Filters (Kernels)",
            "Positional Encoding",
    ...
    {
        "question": "What is the primary advantage of Transformers over traditional RNNs?",
        "options": [
            "Lower memory usage",
            "Sequential processing",
            "Ability to see the entire sentence at once through Attention",
            "Better performance on small CPUs"
        ],
        "correctIndex": 2
    }
]
