...
[
    {
        "question": "Which algorithm does the Go Garbage Collector use?",
        "options": [
            "Reference Counting",
    ...
    {
        "question": "What does the 'Grey' color represent in the Go tri-color GC algorithm?",
        "options": [
            "Trash that should be deleted",
            "Objects that are alive, but their referenced children haven't been checked yet",
            "Objects that have been fully processed",
            "Objects about to be moved to the stack"
        ],
        "correctIndex": 1
    },
    {
        "question": "By default, what percentage of CPU resources (GOMAXPROCS) is allocated to the concurrent GC background workers?",
        "options": [
            "100%",
            "50%",
            "25% (1/4)",
