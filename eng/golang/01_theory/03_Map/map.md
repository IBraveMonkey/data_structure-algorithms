...
[
    {
        ...
        "options": [
            ...
            "int",
            "slice",
            "array (if elements are comparable)"
        ],
        "correctIndex": 2
    },
    {
        "question": "What major change was introduced to Go maps in version 1.24 to improve performance?",
        "options": [
            "Maps were removed and replaced by slices",
            "The implementation switched to 'Swiss Tables' using SIMD instructions for faster searching",
            "Maps became thread-safe by default",
            "The 'delete' function was deprecated"
        ],
        "correctIndex": 1
    },
    {
        "question": "What happens if two goroutines simultaneously read and write to the same map without synchronization?",
        "options": [
            "The map will automatically lock itself",
            "The write operation will be ignored",
            "The program will crash with a fatal error (concurrent map read and map write)",
            "The result will be inconsistent, but the program will continue"
        ],
        "correctIndex": 2
    }
]
