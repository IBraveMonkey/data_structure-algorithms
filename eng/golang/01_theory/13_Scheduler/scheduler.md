...
[
    {
        "question": "What does the GMP model represent in the Go scheduler?",
        "options": [
            "Global Memory Pool",
            "Goroutine, Machine (Thread), Processor",
            "General Multi-Processing",
            "Go Management Platform"
        ],
        "correctIndex": 1
    },
    {
        "question": "What is the 'Work Stealing' mechanism in the Go scheduler?",
        "options": [
            "A way to stop other programs",
            "A process where an idle Processor takes half of the runnable goroutines from another Processor's local queue",
            "A security vulnerability",
            "Moving code to a remote server"
        ],
        "correctIndex": 1
    },
    {
        "question": "What happens during a 'Handoff' if a thread is blocked by a long system call (syscall)?",
        "options": [
            "The program crashes",
            "The Processor is untied from the blocked thread and bound to a new/free thread to continue working",
            "The goroutine is deleted",
            "The OS reboots"
        ],
        "correctIndex": 1
    }
