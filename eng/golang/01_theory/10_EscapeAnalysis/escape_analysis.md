...
func createUser() *User {
    u := User{Name: "Boris"}  // u escapes to heap
    return &u
}
```
...
func addUser() {
    u := User{Name: "Ilyas"}  // u escapes to heap
...
[
    {
        "question": "When is Escape Analysis performed in Go?",
        "options": [
    ...
    {
        "question": "Which memory area is faster for allocation and deallocation?",
        "options": [
            "Heap",
            "Stack",
            "Virtual Memory",
    ...
    {
        "question": "Which of the following scenarios will likely cause a variable to escape to the heap?",
        "options": [
            "Returning a value type by value",
            "A small variable used only inside a function",
