...
[
    {
        ...
        "options": [
            ...
            "A rule requiring specific types to start at memory addresses that are multiples of their size/alignment",
            "Compressing data to save space",
            "Encrypting memory access"
        ],
        "correctIndex": 1
    },
    {
        "question": "What is 'padding' in a Go struct?",
        "options": [
            "Extra space for comments",
            "Empty bytes inserted by the compiler to satisfy alignment requirements",
            "A layer of security",
            "Metadata used by JSON"
        ],
        "correctIndex": 1
    },
    {
        "question": "What is the 'Rule of Thumb' for ordering fields in a struct to minimize memory usage?",
        "options": [
            "Arrange fields alphabetically",
            "Arrange fields from largest to smallest (e.g., int64 -> int32 -> bool)",
            "Smallest to largest",
            "It doesn't matter, Go optimizes it automatically"
        ],
        "correctIndex": 1
    }
]
