...
graph LR
    ...
    recvx((recvx)) --> S1
    sendx((sendx)) --> S3
    style S1 fill:#009688,color:#fff,stroke:#333,stroke-width:2px
    style S2 fill:#009688,color:#fff,stroke:#333,stroke-width:2px
    linkStyle default stroke:#009688,stroke-width:2px;
...
[
    {
        "question": "What is the internal structure that represents a channel in Go?",
        "options": [
            "gopark",
            "hchan",
            "sudog",
    ...
    {
        "question": "What is the 'Direct Copy' optimization in unbuffered channels?",
        "options": [
            "Copying data directly from the sender's stack to the receiver's stack, bypassing any buffer",
            "Automatically converting channels to slices",
            "Skipping the mutex lock",
            "Compressing data before sending"
        ],
        "correctIndex": 0
    },
    {
        "question": "How is the buffer of a buffered channel implemented internally?",
        "options": [
            "As a linked list",
            "As a circular array (buf) with send and receive indices",
            "As a hash map",
            "As a binary tree"
        ],
        "correctIndex": 1
