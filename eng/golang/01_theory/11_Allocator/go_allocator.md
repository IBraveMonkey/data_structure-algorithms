...
> [!NOTE]
> This architecture makes Go one of the fastest languages in terms of memory handling among languages with a Garbage Collector(maybe).

<!-- QUIZ_START 

[
    {
        "question": "What is the minimum unit of memory management in Go, and what is its typical size?",
        "options": [
            "Byte (1B)",
            "Page (8KB)",
            "Arena (64MB)",
    ...
    {
        "question": "What is an 'mspan' in the Go allocator?",
        "options": [
            "A type of thread",
            "A basic building block consisting of one or more continuous pages, cut into objects of the same size class",
    ...
    {
        "question": "Why does the Go allocator use 'Size Classes'?",
        "options": [
            "To categorize programs by importance",
            "To minimize memory fragmentation by allocating objects of similar sizes into specific spans",
            "To encrypt data",
