...
[
    {
        "question": "Is the size of an array part of its type in Go?",
        "options": [
            "No, [3]int and [5]int are the same type",
            "Yes, arrays of different sizes are considered different types",
            "Only for multidimensional arrays",
            "Only if declared with the const keyword"
        ],
        "correctIndex": 1
    },
    {
        "question": "What three fields make up a slice header in Go?",
        "options": [
            "Pointer to array, Capacity, Hash",
            "Pointer to array, Length, Capacity",
            "Length, Capacity, Type",
            "Start index, End index, Array"
        ],
        "correctIndex": 1
    },
    {
        "question": "Why is it mandatory to assign the result of append back to the variable (e.g., s = append(s, x))?",
        "options": [
            "Go doesn't support void functions",
            "Because if capacity is exceeded, append allocates a new array and returns a new pointer",
            "To increase the counter in the GC",
            "It's just a coding style recommendation"
        ],
        "correctIndex": 1
    }
]
