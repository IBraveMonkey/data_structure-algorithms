...
[
    {
        "question": "What is the primary difference between an array and a slice in Go?",
        "options": [
            "Slices are always faster",
            "Arrays have a fixed size, while slices are dynamic descriptors over arrays",
            "Arrays are always stored on the heap",
            "Slices cannot be passed to functions"
        ],
        "correctIndex": 1
    },
    {
        "question": "What happens if you try to access an index that is greater than 'len' but less than 'cap' of a slice?",
        "options": [
            "It returns the zero value",
            "The slice automatically expands",
            "It causes a panic (index out of range)",
            "It returns an error"
        ],
        "correctIndex": 2
    },
    {
        "question": "How does the append() function handle a nil slice?",
        "options": [
            "It causes a panic",
            "It does nothing",
            "It correctly initializes the slice and adds the elements",
            "It returns nil"
        ],
        "correctIndex": 2
    }
