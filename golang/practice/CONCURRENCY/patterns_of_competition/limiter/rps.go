 ...
 * Этот конкретный пример ограничивает количество запросов в секунду (RPS) с помощью тикера.
 * Пример использования: ограничение количества HTTP-запросов к API в секунду, чтобы не превысить лимиты.
 */
package limiter
