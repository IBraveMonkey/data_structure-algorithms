...
> [!NOTE]
> **SIMD (Single Instruction, Multiple Data)** — это технология процессора, позволяющая выполнять одну операцию над группой данных одновременно. В Swiss Tables это используется для мгновенной проверки всей группы из 8 слотов за одну инструкцию.
