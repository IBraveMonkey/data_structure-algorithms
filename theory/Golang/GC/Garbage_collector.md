...
Главная цель GC в Go — **низкая задержка (low latency)**. Go жертвует абсолютной скоростью сборки ради того, чтобы паузы в работе программы (Stop-The-World) были практически незаметны.
